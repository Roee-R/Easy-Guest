...
<table id="table" 
	...
	<th data-field="state" data-checkbox="true"></th>
		<th data-field="serial" data-filter-control="input" data-sortable="true">Serial num</th>
	...
	<th data-field="last" data-filter-control="input" data-sortable="true">Last name</th>
		<th data-field="room" data-filter-control="input" data-sortable="true">Type room</th>
	<th data-field="checkIn" data-filter-control="input" data-sortable="true">check in</th>
	<th data-field="checkOut" data-filter-control="input" data-sortable="true">check out</th>
...
<?php
 ...
 $sql = "SELECT * FROM archiveGuest";
$result = $database->query($sql);
if ($result->num_rows > 0) {
    while($row = $result->fetch_assoc()) {

echo "<tr><td>
      </td><td>". $row["serial"]. "</td><td>". $row["orderNumber"]. "</td><td>". $row["id"] . "</td><td>".$row["firstName"]."</td><td>".$row["lastName"]."</td><td>".$row["typeRoom"]."</td><td>".$row["checkInDate"]."</td
