...
<table id="table" 
	...
	<th data-field="first" data-filter-control="input" data-sortable="true">First name</th>
	...
	<th data-field="pay" data-filter-control="input" data-sortable="true">Total pay</th>
		<th data-field="date" data-filter-control="input" data-sortable="true">Purchase date</th>
	<th data-field="type" data-filter-control="input" data-sortable="true">Payment type</th>
...
<?php
 ...
 $sql = "SELECT * FROM guestPayments";
$result = $database->query($sql);
if ($result->num_rows > 0) {
    while($row = $result->fetch_assoc()) {

echo "<tr><td>
      </td><td>". $row["guestId"]. "</td><td>". $row["firstName"]. "</td><td>". $row["lastName"] . "</td><td>".$row["email"]."</td><td>".$row["totalPay"]."</td><td>".$row["purchaseDate"]."</td><td>".$row["type"]."</td
        ></tr>";
    }
} else {
    echo "0 results";
