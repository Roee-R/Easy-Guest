...
?>
 ...
 <?php
        if(isset($_POST["name"])) {
          ...
          $order = $_POST["name"];
          $sql =   "INSERT INTO restOrdersArchive( SELECT * FROM restOrders WHERE '$order'=guestOrderNum)";
          $sql2 = "DELETE FROM restOrders where '$order'=guestOrderNum";        
...
echo "<tr><td>
        ...
        echo "<td> <button id='".$row["guestOrderNum"]."' type='button' class='btn btn-circle btn-raised btn-success' onclick='deleteRow(this.id)' name='".$row["guestOrderNum"]."'><span class='glyphicon glyphicon-ok'></span></button></td>";
...
function deleteRow(bt) {
      ...
      var xhttp = new XMLHttpRequest();
        xhttp.open("POST", "restOrderTable.php", true);
