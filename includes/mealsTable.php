...
<table id="table" 
	...
	<th data-field="persons" data-filter-control="input" data-sortable="true">Number of persons</th>
	<th data-field="date" data-filter-control="input" data-sortable="true">Date</th>
	<th data-field="type" data-filter-control="input" data-sortable="true">Meals type</th>
		<th data-field="guest" data-filter-control="input" data-sortable="true">Guest</th>
...
echo "<tr><td>
      </td><td>". $row["id"]. "</td><td>". $row["numberOfPersons"]. "</td><td>". $row["date"] . "</td><td>".$row["mealsType"]."</td><td>".$row["user"]."</td><td>".$row["price"]."</td></tr>";
    }
} else {
    echo "0 results";
}
